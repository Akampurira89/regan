...
import {
  ...
  Database, Menu, X, LogOut, Moon, Sun, Receipt, Calculator, HandCoins,
} from 'lucide-react'
...
const NAV = [
  ...
  { key: 'sales', to: '/sales/history', label: 'Sales History', icon: Receipt },
  ...
  { key: 'consignment', to: '/consignment', label: 'Consignment / Borrowed', icon: HandCoins },
      ...
      >
        <div className="h-16 flex items-center gap-2 px-4 border-b border-gray-100 dark:border-gray-800">
          {template.logo_url ? (
            ...
            <div className="w-8 h-8 rounded bg-brand text-white flex items-center justify-center font-bold">E</div>
          )}
