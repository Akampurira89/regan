    ...
    <div className="grid lg:grid-cols-3 gap-4">
      ...
      <Card title="Current Sale" actions={<ShoppingCart size={16} className="text-gray-400" />} className="h-fit lg:sticky lg:top-20">
        ...
        {(paymentMethod === 'mtn_momo' || paymentMethod === 'airtel_money') && (
          <a href={paymentMethod === 'mtn_momo' ? `tel:*165%23` : `tel:*185%23`} className="block text-center text-xs text-blue-600 mt-2 underline">
            Open dialer to prompt {paymentMethod === 'mtn_momo' ? 'MTN MoMo' : 'Airtel Money'} payment on customer's phone
          </a>
        )}
